...
interface IndexProps {
  directoryData: any; // Replace 'any' with the actual type of your data
}

const Index = ({ directoryData }: IndexProps) => {
...
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  const filePath = path.join(process.cwd(), 'src/data/directoryData.json');
